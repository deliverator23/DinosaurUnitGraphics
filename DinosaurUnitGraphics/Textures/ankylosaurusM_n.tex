...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/DinosaurUnitGraphics\SourceTextures\ankylosaurusM_n.DDS"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3024189806</m_ExportedTime>
	<m_ClassName text="Generic_Normal"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="ankylosaurusM_n.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="ankylosaurusM_n"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
