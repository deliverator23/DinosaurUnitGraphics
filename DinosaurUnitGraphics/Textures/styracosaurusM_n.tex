...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/DinosaurUnitGraphics\SourceTextures\styracosaurusM_n.DDS"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3458026416</m_ExportedTime>
	<m_ClassName text="Generic_Normal"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="styracosaurusM_n.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="styracosaurusM_n"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
